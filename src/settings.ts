  ...
  getSettingDefinitions(): SettingDefinitionItem<AuroraSettingKey>[] {
    return [
      ...
      },
      {
        ...
        desc: "Show Aurora Dashboard automatically when the Obsidian workspace is ready.",
        control: {
          type: "toggle",
          key: "openOnStartup",
          defaultValue: true
      ...
      {
        name: "Startup mode",
        desc: "Replace the active tab for a home-screen feel, or open a new tab to keep your current note.",
        control: {
          type: "dropdown",
          key: "startupMode",
      ...
      },
      {
        ...
        desc: "Notes with this many words or fewer are classified as empty or very short.",
        control: {
          type: "slider",
      ...
      },
      {
        ...
        desc: "Daily additions before installation cannot be reconstructed exactly. When enabled, they are estimated from each file's current word count and last-modified date.",
        control: {
          type: "toggle",
      ...
      },
      {
        ...
        desc: "Choose how many days appear in the dashboard activity calendar.",
        control: {
          type: "dropdown",
...
function renderSettings(
  ...
  container.empty();
  container.createEl("h2", { text: "Aurora Dashboard settings" });
  container.createEl("p", {
    cls: "setting-item-description aurora-settings-intro",
    text: "All statistics and activity history stay in this vault and are never sent over the network."
  });
  ...
  new Setting(container)
    ...
    .setDesc("Show Aurora Dashboard automatically when the Obsidian workspace is ready.")
    .addToggle((toggle) =>
      toggle
  ...
  new Setting(container)
    ...
    .setDesc("Replace the active tab for a home-screen feel, or open a new tab to keep your current note.")
  ...
  new Setting(container)
    ...
    .setDesc("Notes with this many words or fewer are classified as empty or very short.")
    .addSlider((slider) =>
      slider
        .setLimits(0, 100, 5)
  ...
  new Setting(container)
    ...
    .setDesc(
      "Daily additions before installation cannot be reconstructed exactly. When enabled, they are estimated from each file's current word count and last-modified date."
    )
    .addToggle((toggle) =>
      toggle
  ...
  new Setting(container)
    ...
    .setDesc("Choose how many days appear in the dashboard activity calendar.")
    .addDropdown((dropdown) =>
      dropdown
